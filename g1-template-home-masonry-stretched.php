...
?>
	...
	<div class="g1-row g1-row-wide g1-row-layout-page archive-body">
						...
						<div class="g1-collection-viewport">
							<ul class="g1-collection-items">
								...
								<?php while ( have_posts() ) : the_post(); ?>
									<?php do_action( 'bimber_home_loop_before_post', 'grid', $wp_query->current_post + 1 ); ?>

									<li class="g1-collection-item g1-collection-item-1of3">
										<?php get_template_part( 'template-parts/content-grid-masonry', get_post_format() ); ?>
									</li>

									<?php do_action( 'bimber_home_loop_after_post', 'grid', $wp_query->current_post + 1 ); ?>
								<?php endwhile; ?>
							</ul>
						</div>
