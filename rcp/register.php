		...
		<ul id="rcp_subscription_levels">
			<?php foreach( $levels as $key => $level ) : ?>
				...
				<li class="rcp_subscription_level rcp_subscription_level_<?php echo $level->id; ?>">
					<div class="g1-pricingtable">
						<div class="g1-pricingtable-header">
							<h3 class="g1-delta g1-delta-2nd rcp_subscription_level_name"><?php echo rcp_get_subscription_name( $level->id ); ?></h3>

							<span class="g1-alpha g1-alpha-1st rcp_price" rel="<?php echo esc_attr( $level->price ); ?>"><?php echo $level->price > 0 ? rcp_currency_filter( $level->price ) : __( 'free', 'rcp' ); ?><span class="rcp_separator">&nbsp;-&nbsp;</span></span>

							<p class="rcp_level_duration"><?php echo $level->duration > 0 ? $level->duration . '&nbsp;' . rcp_filter_duration_unit( $level->duration_unit, $level->duration ) : __( 'unlimited', 'rcp' ); ?></p>
						...
						<div class="g1-pricingtable-body">
