<?php
/**
 * Template for displaying popular posts.
 *
...
$bimber_limit      = bimber_get_popular_posts_limit();
$bimber_post_ids   = bimber_get_popular_post_ids( $bimber_limit );
...
$bimber_query_args = apply_filters( 'bimber_popular_posts_query_args', $bimber_query_args );
...
<?php if ( $bimber_query->have_posts() ) : ?>
	...
	<?php
	$bimber_settings = apply_filters( 'bimber_popular_entry_settings', array(
		'elements' => array(
			'featured_media' => true,
			'avatar'         => false,
			'categories'     => false,
